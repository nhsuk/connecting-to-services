...
describe('app', () => {
  it('should include required security headers', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        expect(res).to.have.header('Content-Security-Policy', 'connect-src \'self\' assets.adobedtm.com *.demdex.net *.google-analytics.com *.hotjar.com:* nhs.funnelback.co.uk; default-src \'self\'; font-src *.hotjar.com *.nhs.uk; img-src \'self\' data: *.2o7.net *.google-analytics.com *.hotjar.com *.omtrdc.net *.webtrends.com *.webtrendslive.com *.nhs.uk; script-src \'self\' \'unsafe-eval\' \'unsafe-inline\' data: assets.adobedtm.com *.demdex.net *.google-analytics.com *.hotjar.com *.webtrends.com *.webtrendslive.com; style-src \'self\' \'unsafe-inline\' *.nhs.uk; worker-src *.hotjar.com');
