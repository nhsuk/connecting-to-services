...
describe('addAddressLine', () => {
  it(
    'should add first non-empty address line as addressLine property',
    () => {
  ...
  it(
    'should add second address line as addressLine property if first line empty',
    () => {
      const services = getValidServices();
      services.forEach((s) => {
        s.address.line1 = '';
  ...
  it(
    'should add third address line as addressLine property if first two lines are empty',
    () => {
      const services = getValidServices();
      services.forEach((s) => {
        s.address.line1 = '';
  ...
  it(
    'should handle missing address lines',
    () => {
      const services = getValidServices();
      services.forEach((s) => {
